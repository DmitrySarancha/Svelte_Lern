...
<label class="swap swap-rotate flex-none">
    ...
    <input type="checkbox" checked on:click={colorTheme} />
    <!-- sun icon -->
    <svg
        class="swap-on fill-yellow-400 w-10 h-10"
    ...
    <!-- moon icon -->
    <svg
        class="swap-off fill-sky-300 w-10 h-10"
        style="filter: drop-shadow(rgb(255, 255, 255) 2px 2px 8px);"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        ><path
